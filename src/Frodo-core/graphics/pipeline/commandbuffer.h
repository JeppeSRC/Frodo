...
public:
	...
	void Begin(CommandBufferUsage usage, bool waitForFence, const RenderPass* const renderPass = nullptr, uint32 framebufferIndex = 0);
	void End();
...
public:
	...
	void Begin(CommandBufferUsage usage, bool waitForFence, const RenderPass* const renderPass = nullptr);
	void End();
